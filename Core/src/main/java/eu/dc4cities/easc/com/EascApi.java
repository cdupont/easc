...
/**
 * interface that the EASC should respect with the CTRL
 */
public interface EascApi {

	EascActivitySpecifications getActivitySpecifications(TimeParameters timeParams);
	
	boolean executeActivityPlan(EascActivityPlan activityPlan);
	
	EascActivityPlan getActivityPlan();
	
	EascMetrics getMonitoringMetrics(TimeParameters timeParams);
}
