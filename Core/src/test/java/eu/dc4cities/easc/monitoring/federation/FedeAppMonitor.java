...
public class FedeAppMonitor extends Monitor {
	MonitorResource monitorServer;
	MonitorResource monitorVM;
	MonitorActivityWorkingMode monitorActivity;

	public FedeAppMonitor() {
		this.monitorActivityAndWorkingmode = new FedeAppMonitorActivityWorkingMode();
		this.monitorServer = new FedeAppMonitorServer();
		this.monitorVM = new FedeAppMonitorVM();
	}
	...
	public void init() {
		...
		//register activites for the monitoring system
		this.initWorkDone("activity.DC1");
		this.initWorkDone("activity.DC2");
