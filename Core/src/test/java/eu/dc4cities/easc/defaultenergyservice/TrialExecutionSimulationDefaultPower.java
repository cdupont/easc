...
public class TrialExecutionSimulationDefaultPower {
	...
	public void main() {
        ...
        Optional<ServerConfig> serverConfig = ConfigReader.readServerConfig(configDirectory);
	    if(serverConfig.isPresent()) {
	    	es.setServerConfig(serverConfig.get());
	    } else {
	    	System.out.println("There is no server config.");
	    	assert(false);
	    }
