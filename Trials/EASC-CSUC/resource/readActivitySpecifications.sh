...
curl -i -X POST -H "Content-Type: application/json; charset=utf-8" -d @"timeParams3DaysHorizon.json" http://localhost:9999/v1/easc/EASC-CSUC/activityspecifications 
